...
func (c *clients) execute(ctx context.Context, recordID, batchID string, action commonv1.ActionType, attemptNumber int32, amountPaise int64) (*executorv1.ExecuteResponse, error) {
	callCtx, cancel := context.WithTimeout(ctx, c.callTimeout)
	defer cancel()
