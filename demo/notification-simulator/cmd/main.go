// Command notification-simulator is the entrypoint for the notification-simulator service.
//
...
func run(ctx context.Context, log *slog.Logger) error {
	// TODO(notificationsimulator): load+validate config (fail fast), dial dependencies,
